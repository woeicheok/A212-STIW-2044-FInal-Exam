...
import 'package:mytutor2/model/cart.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  void _loadCart() {
    http.post(Uri.parse(CONSTANTS.server + "/mobile/php/load_cart.php"), body: {
      ...
      if (response.statusCode == 200 && jsondata['status'] == 'success') {
        ...
        if (extractdata['cart'] != null) {
          ...
          titlecenter = qty.toString() + " items in your cart";
          setState(() {});
        }
      } else {
        titlecenter = "Your Cart is Empty. Please add something 🥺 ";
        cartList.clear();
        setState(() {});
      }
    });
  ...
  void _updateCart(int index, String s) {
    ...
    http.post(Uri.parse(CONSTANTS.server + "/mobile/php/update_cart.php"),
  ...
  void _deleteItem(int index) {
    http.post(Uri.parse(CONSTANTS.server + "/mobile/php/delete_cart.php"),
        body: {
          'customer_email': widget.user.email,
